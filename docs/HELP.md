...
* [Spring Web Services](https://docs.spring.io/spring-boot/3.5.9-SNAPSHOT/reference/io/webservices.html)
* [OAuth2 Client](https://docs.spring.io/spring-boot/3.5.9-SNAPSHOT/reference/web/spring-security.html#web.security.oauth2.client)
